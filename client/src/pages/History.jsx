    ...
    <div style={{ maxWidth: '900px' }}>
      ...
      {loading ? (
        ...
        <div className="card" style={{ padding: '4rem', textAlign: 'center' }}>
          ...
          <p style={{ fontWeight: '500', marginBottom: '0.5rem' }}>No documents yet</p>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem', marginBottom: '1.5rem' }}>
            Upload your first legal document to get started.
          </p>
          <button
            onClick={() => navigate('/upload')}
            style={{ padding: '0.75rem 1.5rem', background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 'var(--radius-md)', cursor: 'pointer', fontWeight: '500' }}
          >
            Analyse a document
          </button>
        </div>
